            ...
            $stocks.each(function () {
                ...
                var $symbolLink = $("<li>")
                    ...
                    .mouseenter(function () {
                        ...
                        // Wait 3 seconds before showing the stock information
                        setTimeout(function () {
                            ...
                            var html = "<ol>" +
                                ...
                                "<li>Year Range = " + $low.text() + " - " + $high.text();
                            ...
                            if ($dividend.attr("available") == "true") {
                                ...
                                html += "<br>" +
                                    "<li>Dividend = " + $amount.text() + " (" + $yield.text() + " yield, " + $frequency.text() + " frequency)" + "</li></ol>";
                            }
                            // If the stock does not have a dividend, add a message to the string
                            if ($dividend.attr("available") == "false") {
                                html += "<br>" +
                                    "<li> Dividend is not available </li> </ol>";
                            }
